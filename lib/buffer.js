...
//a= new Date("2016-12-23");
//b = new Date("2016-12-22");
...
Teleinfo.prototype.parse = function(packet) {
 ...
 // if(a.getDate() !== b.getDate()) {
    ...
    sails.log.info('Teleinfo : Summarize index info for day ' + buffer.date);
    //sails.log.info('Teleinfo : Summarize index info for day ' + tmpDate);
    summarize({device: self._init.device, yesterday: tmpDate, today: now})

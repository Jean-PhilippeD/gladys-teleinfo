    ...
    <div class="teleinfo-panel">
        ...
        <div class="teleinfo-content">
          ...
          <div class="teleinfo-value teleinfo-normal" class="teleinfo-circle teleinfo-warning">
            ...
            <span ng-show="vm.dayCost" class="teleinfo-data">{{vm.dayCost | number:2}} €</span>
            <span ng-show="!vm.dayCost" class="teleinfo-data"><i class="fa-spinner fa fa-spin"></i></span>
          </div>
        </div>
    </div>
    <div class="teleinfo-detail">
      <div class="teleinfo-see-detail">
        <button ng-click="vm.showDetail()" class="btn btn-default btn-xs" ng-show="!vm.more">&nbsp;&nbsp;<i class="fa fa-chevron-down"></i>&nbsp;&nbsp;</button>
        <button ng-click="vm.more = false" class="btn btn-default btn-xs" ng-show="vm.more">&nbsp;&nbsp;<i class="fa fa-chevron-up"></i>&nbsp;&nbsp;</button>
      </div>

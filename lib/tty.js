...
module.exports = function(port) {
        ...
        sails.log.info('Teleinfo : Listening on device ' + port);
...
function decodeLigne(ligneBrute, trame, trameEvents) {
    ...
    // hack because sometime PTEC has only 2 field instead of 3
    if (elementsLigne[0] === 'PTEC' && elementsLigne.length === 4) {
      elementsLigne.splice(2,1,'A');
      elementsLigne.splice(3,1);
    }
